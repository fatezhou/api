...
Page({
  ...
  toeditRecord:function(e){
    ...
    wx.navigateTo({
      url: '../pull/editRecord?authorId=' + item.authorId + '&avatarUrl=' + item.avatarUrl + '&name=' + item.name + '&pictureUrls=' + item.pictureUrls + '&recordId=' + item.recordId + '&studentId=' + item.studentId + '&text=' + item.text,
    })
  },
