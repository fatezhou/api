  ...
  onLoad: function (t) {
    ...
    app.util.request({
      ...
      success: function (res) {
        ...
        if (t.room_id == 143 || t.room_id == 144 || t.room_id == 72 || t.room_id == 112 || t.room_id == 113 || t.room_id == 114 || t.room_id == 115 || t.room_id == 116 || t.room_id == 117 || t.room_id == 118 || t.room_id == 131 || t.room_id == 132 || t.room_id == 133 || t.room_id == 134 || t.room_id == 146 || t.room_id == 147 || t.room_id == 149 || t.room_id == 150 || t.room_id == 151 || t.room_id == 152 || t.room_id == 153 || t.room_id == 154 || t.room_id == 191 || t.room_id == 192 || t.room_id == 207 || t.room_id == 208 || t.room_id == 215 || t.room_id == 240){
  ...
  room_num: function (t) {
    ...
    app.util.request({
      ...
      success: function (t) {
        ...
        }), t.data) ((t.data[o].nums <= 0 && e.push(t.data[o])) || (((d.data.room_id == 207 || d.data.room_id == 208) && t.data[o].nums <= 1) && e.push(t.data[o])));
