...
Page({
    data: {
      ...
      city: "定位中",
      currentCityCode: '',
      hotcityList: [{ cityCode: 350200, city: '厦门市' }, { cityCode: 310000, city: '上海市' }, { cityCode: 440100, city: '广州市' }, { cityCode: 510100, city: '成都市' }, { cityCode: 500000, city: '重庆市' }, { cityCode: 210200, city: '大连市' }, { cityCode: 420100, city: '武汉市' }, { cityCode: 120000, city: '天津市' }, { cityCode: 610100, city: '西安市' },],
  ...
  bindCity: function (t) {
    ...
    // console.log(appInstance.globalData.defaultCity)
    var e = this, a = t.currentTarget.dataset.city;
    if (a.charAt(a.length - 1) == "市"){
