...
<ul class="nav nav-tabs">
  ...
  <li class="active"><a href="<?php  echo $this->createWebUrl('incoupon')?>">优惠券管理</a></li>
  <li><a href="<?php  echo $this->createWebUrl('inaddcoupon')?>">添加优惠券</a></li>
</ul>
</ul>
    ...
    <div class="table-responsive">
      <table class="col-md-12">
        ...
        <tr class="yg5_tr2">
          ...
          <td > 
              <a href="<?php  echo $this->createWebUrl('inlqlist',array('id'=>$item['id']));?>" class="storespan btn btn-xs">
            <span class="fa fa-database"></span>
            <span class="bianji">查看领取记录
              <span class="aritemdown"></span>
            </span>                            
          </a>
           <a href="<?php  echo $this->createWebUrl('inaddcoupon',array('id'=>$item['id']));?>" class="storespan btn btn-xs">
            <span class="fa fa-pencil"></span>
            <span class="bianji">编辑
              <span class="arrowdown"></span>
            </span>                            
          </a>
          <a class="storespan btn btn-xs" href="<?php  echo $this->createWebUrl('incoupon', array('id'=>$item['id'],'op'=>'delete'))?>" onclick="return confirm('确认删除吗？');return false;">
