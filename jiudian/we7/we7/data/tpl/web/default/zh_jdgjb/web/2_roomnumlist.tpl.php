...
<table class="table table-hover room" border="1" style="border:1px solid #999;">
  ...
  <table class="table table-hover" border="1" >
    <tr>
      ...
      <td style="width: 12.5%;background-color: #f4f6f9;"><?php  echo $item['name'];?></td>
        ...
        <td style="width: 8.2%">
            <span class="price_span"><?php  echo $item1['nums'];?></span>
            <span class="price_editspan hide">
                <input type="text" pid="<?php  echo $item1['pid'];?>" dateday="<?php  echo $item1['dateday'];?>" rid="<?php  echo $item1['rid'];?>" class="price_input form-control" value="<?php  echo $item1['nums'];?>" />
            </span>
        </td>
        <?php  } } ?>
        <td style="width: 2.5%%"></td>
