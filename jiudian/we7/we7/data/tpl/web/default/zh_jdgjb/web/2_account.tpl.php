...
<ul class="nav nav-tabs">
    ...
    <li><a href="<?php  echo $this->createWebUrl('addaccount')?>">添加/编辑账号</a></li>
</ul>
<div class="main">
    <div class="panel panel-default ygbody">
        <div class="panel-body">
            <p class="yangshi">酒店后台登陆地址:&nbsp;&nbsp;<a href="<?php  echo $_W['siteroot'];?>web/zhjd.php?c=user&a=login" target="_blank"><?php  echo $_W['siteroot'];?>web/zhjd.php?c=user&a=login</a></p>
        </div>
    </div>
            ...
            <div class="row">
                <table class="yg5_tabel col-md-12">
                    ...
                    <tr class="yg5_tr2">
                        ...
                        <td><div class="type-parent"><?php  echo $item['user_name'];?></div></td>
                        <!-- <td><a class="btn btn-info btn-sm" href="javascript:void(0);">店长</a></td> -->
                        <?php  if($item['status']==2) { ?>
                      <td><a class="btn storeblue btn-xs">启用</a></td> 
                      <?php  } else if($item['status']==1) { ?>
                       <td><a class="btn storegrey btn-xs">禁用</a></td> 
                       <?php  } ?>
                        <td>
                            <a href="<?php  echo $this->createWebUrl('addaccount', array('id' => $item['id']))?>" class="storespan btn btn-xs">
