            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text"  name="link_tel" value="<?php  echo $list['link_tel'];?>" class="form-control" id="inputEmail3" placeholder="请填写联系人电话">
                        ...
                        <div class="form-group">
                <label for="inputEmail3" class="col-sm-2 control-label">绑定管理员</label>
                <div class="col-sm-10">
                    <div class="col-sm-12" style="padding: 0px;">
                        <select class="col-sm-6" name="user_id" id="username2">
                           <?php  if($userinfo2['name']) { ?>
                            <option value="<?php  echo $userinfo2['id'];?>" selected="selected"><?php  echo $userinfo2['name'];?></option>
                            <?php  } ?>
                              <option value="0" id="select_people" name="user_id">绑定管理员</option>
...
<div class="form-group">
  ...
  <div class="col-sm-10">
    <input type="text"  name="zd_money" value="<?php  echo $list['zd_money'];?>" class="form-control" id="inputEmail3" placeholder="请填写最低金额">
  </div>
</div>
<div class="form-group">
  ...
  <div class="col-sm-10">
    <div class="col-sm-12" style="padding: 0px;">
      <select class="col-sm-6" name="bd_id" id="username">
        ...
        <option value="0" id="select_people" name="user_id">绑定提现人</option>
    ...
    $(function(){
      ...
      $(".ygbtn2").on("click",function(){
            ...
            if(ygsinput2.length==''){
              ...
              $.ajax({
                  type:"post",
                  url:"<?php  echo $_W['siteroot'];?>/app/index.php?i=<?php  echo $_W['uniacid'];?>&c=entry&do=SelectUser2&m=zh_jdgjb",
                  dataType:"text",
                  data:{keywords:keywords},
                  success:function(data){                    
                      var data = eval('(' + data + ')')
