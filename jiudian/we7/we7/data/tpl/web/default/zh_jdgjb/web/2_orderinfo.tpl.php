...
<style type="text/css">
    ...
    <ul class="nav nav-tabs">
        ...
        <li ><a href="<?php  echo $this->createWebUrl('order')?>">订单管理</a></li>
        <li class="active"> <a href="<?php  echo $this->createWebUrl('orderinfo')?>">订单详情</a></li>
    </ul>
    <div class="main">
...
<div class="panel panel-default">        
   ...
   <div class="form-group">
    ...
    <div class="col-sm-offset-2 col-sm-10">
        ...
        <a class="btn btn-info"  style="vertical-align: baseline" href="<?php  echo $this->createWebUrl('order',array('order_id'=>$list['id'],'op'=>'query'));?>"> 确认订单</a>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <a class="btn btn-danger"  style="vertical-align: baseline" href="<?php  echo $this->createWebUrl('order',array('order_id'=>$list['id'],'op'=>'jjorder'));?>"> 拒绝订单</a>
        <?php  } ?>
        
        <?php  if($list['status']==10  or $list['status']==2&& $sys['is_order']==2 or $list['type']==3&&$list['status']==1&& $sys['is_order']==2) { ?>
        <a class="btn btn-info"  style="vertical-align: baseline" href="<?php  echo $this->createWebUrl('order',array('id'=>$list['id'],'op'=>'rz'));?>"> 确认入住</a>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <a class="btn btn-danger"  style="vertical-align: baseline" href="<?php  echo $this->createWebUrl('order',array('order_id'=>$list['id'],'op'=>'jjrz'));?>"> 拒绝入住</a>
        <?php  } ?>

        
        <?php  if($list['status']==6) { ?>
        <a  class="btn btn-success" style="vertical-align: baseline" href="<?php  echo $this->createWebUrl('order',array('order_id'=>$list['id'],'op'=>'refund'));?>">确认退款</a>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a class="btn btn-danger" href="<?php  echo $this->createWebUrl('order',array('order_id'=>$list['id'],'op'=>'reject'));?>">拒绝退款</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        
        <?php  } ?> 

        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <a class="btn btn-warning return" style="vertical-align: baseline" href="<?php  echo $this->createWebUrl('order');?>"> 返回列表</a> 
    </div>
</div>
