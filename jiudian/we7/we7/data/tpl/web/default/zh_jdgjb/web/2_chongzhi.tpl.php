                       ...
                       <script type="text/javascript">
                         $(function(){
                            $(".shanchu<?php  echo $row['id'];?>").click(function(){          
                                  ...
                                  $.ajax({
                                      type:"post",
                                      url:"<?php  echo $_W['siteroot'];?>/app/index.php?i=<?php  echo $_W['uniacid'];?>&c=entry&do=DelCz&m=zh_jdgjb",
                                      dataType:"text",
                                      data:{id:id},
  ...
  var num = $(".addmyli").length;
    $(function(){
        ...
        $("input[name='button']").click(function(){
          ...
          $.ajax({
              type:"post",
              url:"<?php  echo $_W['siteroot'];?>/app/index.php?i=<?php  echo $_W['uniacid'];?>&c=entry&do=AddCz&m=zh_jdgjb",
              dataType:"text",
              data:{list:list},
              success:function(data){
                  // alert(data)
