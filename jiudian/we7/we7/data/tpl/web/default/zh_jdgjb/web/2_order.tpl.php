...
<ul class="nav nav-tabs">
  <li  <?php  if($type=='all') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('order',array('type'=>all));?>">全部订单</a></li>
  <li   <?php  if($type=='wait') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('order',array('type'=>wait,'status'=>1));?>">待支付</a></li>
  <li   <?php  if($type=='pay') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('order',array('type'=>pay,'status'=>2));?>">已付款</a></li>
  <li   <?php  if($type=='cancel') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('order',array('type'=>cancel,'status'=>3));?>">已取消</a></li>
  <li   <?php  if($type=='complete') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('order',array('type'=>complete,'status'=>4));?>">已完成</a></li>
   <li   <?php  if($type=='rz') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('order',array('type'=>rz,'status'=>5));?>">已入住</a></li>
    <li   <?php  if($type=='refund') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('order',array('type'=>refund,'status'=>6));?>">待退款</a></li>
    <li   <?php  if($type=='completerefund') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('order',array('type'=>completerefund,'status'=>7));?>">已退款</a></li>
    <li   <?php  if($type=='reject') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('order',array('type'=>reject,'status'=>8));?>">退款拒绝</a></li> 
  </ul>
  <div class="row ygrow">
    <form action="" method="get" class="col-md-3">
       ...
       <div class="input-group">
        <input type="text" name="keywords" class="form-control"  value="<?php  echo $_GPC['keywords'];?>" placeholder="请输入酒店名称/入住人姓名/手机号" style="font-size: 12px;">
      ...
      <table class="col-md-12">
       ...
       <td>
        ...
        <?php  if($item['status']==2 && $item['voice']==1 or $item['status']==1 && $item['type']==3 && $item['voice']==1) { ?>
          <a href="<?php  echo $this->createWebUrl('order',array('order_id'=>$item['id'],'op'=>'close'));?>" class="storespan btn btn-xs">
