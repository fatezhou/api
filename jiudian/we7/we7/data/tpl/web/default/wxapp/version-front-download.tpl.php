...
<ul class="we7-page-tab">
	...
	<li class="<?php  if($do == 'domainset') { ?>active<?php  } ?>">
		...
		<li class="<?php  if($do == 'entrychoose') { ?>active<?php  } ?>">
...
<div ng-controller="code_appjson_ctrl" id="codeappjson" ng-controller="codeAppjsonCtrl">
	...
	<a href="<?php  echo url('wxapp/front-download/custom_default', array('version_id' => $version_id));?>" class="btn btn-primary">恢复默认</a>
	<a href="<?php  echo url('wxapp/front-download/custom_save', array('version_id' => $version_id));?>" class="btn btn-primary">保存</a>
