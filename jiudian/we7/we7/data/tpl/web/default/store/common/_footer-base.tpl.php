	...
	<div class="container-fluid footer text-center" role="footer">	
		<div class="friend-link">
			<?php  if(empty($_W['setting']['copyright']['footerright'])) { ?>
				<a href="http://www.maomikj.cn">猫咪科技</a>
				<a href="http://www.maomikj.cn">猫咪科技</a>
				<a href="http://bbwww.maomikj.cn">猫咪科技</a>
				<a href="http://www.maomikj.cn">联系客服</a>
			<?php  } else { ?>
				<?php  echo $_W['setting']['copyright']['footerright'];?>
			<?php  } ?>
		</div>
		<div class="copyright"><?php  if(empty($_W['setting']['copyright']['footerleft'])) { ?>Powered by <a href="http://www.maomikj.cn"><b>猫咪</b></a> v<?php echo IMS_VERSION;?> &copy; 2014-2015 <a href="http://www.maomikj.cn">www.maomikj.cn</a><?php  } else { ?><?php  echo $_W['setting']['copyright']['footerleft'];?><?php  } ?></div>
