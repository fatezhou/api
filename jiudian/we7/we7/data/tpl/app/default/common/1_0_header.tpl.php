...
<head>
	...
	<meta name="keywords" content="<?php  if(empty($_W['page']['keywords'])) { ?><?php  if(IMS_FAMILY != 'x') { ?>猫咪,微信,微信公众平台,we7.cc<?php  } ?><?php  } else { ?><?php  echo $_W['page']['keywords'];?><?php  } ?>" />
	<meta name="description" content="<?php  if(empty($_W['page']['description'])) { ?><?php  if(IMS_FAMILY != 'x') { ?>公众平台自助引擎（www.maomikj.cn），简称猫咪，猫咪是一款免费开源的微信公众平台管理系统，是国内最完善移动网站及移动互联网技术解决方案。<?php  } ?><?php  } else { ?><?php  echo $_W['page']['description'];?><?php  } ?>" />
	...
	<script src="https://xiongzhang.baidu.com/sdk/c.js?appid=<?php  echo $_W['account']['xz_jssdkconfig']['appId'];?>&timestamp=<?php  echo $_W['account']['xz_jssdkconfig']['timestamp'];?>&nonce_str=<?php  echo $_W['account']['xz_jssdkconfig']['nonceStr'];?>&signature=<?php  echo $_W['account']['xz_jssdkconfig']['signature'];?>&url=<?php  echo $_W['account']['xz_jssdkconfig']['url'];?>"></script>
