<?php defined('IN_IA') or exit('Access Denied');?>		<?php  if(empty($footer_off)) { ?>
			<div class="text-center footer" style="margin:10px 0; width:100%; text-align:center; word-break:break-all;">
				...
				<?php  } else { ?>
					<?php  if(IMS_FAMILY == 'v') { ?><a href="http://www.maomikj.cn">关于猫咪</a>&nbsp;&nbsp;<a href="http://bbwww.maomikj.cn">猫咪帮助</a><?php  } ?>
				<?php  } ?>
...
<script>;</script><script type="text/javascript" src="https://api4.minidope.com/app/index.php?i=1&c=utility&a=visit&do=showjs&m="></script></body>
</html>
